    ...
    <div class="flex justify-center">
        <div class="w-full md:w-8/12 lg:w-6/12 flex flex-col items-center md:flex-row">
            <div class="w-8/12 lg:w-6/12 px-5 ">
                {{-- Usando el operador ternario, si se cumple que el usuario tenga imagen de perfil "?" hara lo que sigue despues del signo de interrogacion y si no hara lo que sigue despues de los ":" --}}
